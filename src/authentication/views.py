...
from manager.models import Center
...
def register(request):
    if request.method == 'POST':
        ...
        if employee_form.is_valid():
            ...
            user.center = Center.objects.get(id=request.POST.get('center'))
            user.save()
    ...
    return render(request, 'register.html', {'employee_form': employee_form, 'centers': centers})